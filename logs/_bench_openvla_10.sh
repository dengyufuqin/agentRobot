#!/bin/bash
#SBATCH --job-name=bench-10
#SBATCH --partition=all
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --exclude=cn23
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/bench-openvla-10-%j.log
...
for i in $(seq 1 60); do
  curl -s http://localhost:18812/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
