...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-openvla-maniskill:PlugCharger-v1-%j.log



export HF_HOME=/mnt/vast/home/yd66byne/.cache/huggingface

echo "=== Benchmark: openvla on maniskill:PlugCharger-v1 ==="
