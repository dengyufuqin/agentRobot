...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-pi0-robotwin:handover_block-%j.log

#SBATCH --exclude=cn16,cn17,cn19



echo "=== Benchmark: pi0 on robotwin:handover_block ==="
