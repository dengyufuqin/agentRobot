...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-dp-robotwin:beat_block_hammer-%j.log

#SBATCH --exclude=cn16,cn17,cn19



echo "=== Benchmark: dp on robotwin:beat_block_hammer ==="
...
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/mnt/vast/home/yd66byne/code/agentRobot/agentic/policy_websocket/src:/mnt/vast/home/yd66byne/code/agentRobot/RoboTwin/policy/DP /mnt/vast/home/yd66byne/code/agentRobot/RoboTwin/policy/DP/.venv/bin/python3 /mnt/vast/home/yd66byne/code/agentRobot/RoboTwin/policy/DP/policy_server.py --checkpoint /mnt/vast/workspaces/JAIF/dy/datasets/agent_robot/checkpoints/robotwin_ckpts/dp_avada11_beat_block_hammer/500.ckpt --port 26217 --task beat_block_hammer --action_dim 14 --n_obs_steps 3 --n_action_steps 6 &
SERVER_PID=$!

# Step 2: Wait for server
for i in $(seq 1 60); do
  curl -s http://localhost:26217/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
