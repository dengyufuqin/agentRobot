...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/eval-octo-x-%j.log

# ============================================================
#  Octo × ManiSkill + RoboTwin (re-run with fixes)
#  Fix: ManiSkill torch cu124, RoboTwin assets downloaded
# ============================================================
...
echo "============================================"
echo "  Octo × ManiSkill + RoboTwin (v2 — fixes)"
