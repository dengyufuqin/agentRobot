...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-rdt-maniskill:PegInsertionSide-v1-%j.log





echo "=== Benchmark: rdt on maniskill:PegInsertionSide-v1 ==="
