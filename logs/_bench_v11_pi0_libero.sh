...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/v11-pi0-lib-%j.log

# ============================================================
#  v11: pi0 × LIBERO (READY — expect ~94%)
...
echo "============================================"
echo "  v11: pi0 × LIBERO (preflight-gated)"
echo "  $(date) | Node: $(hostname)"
echo "============================================"
nvidia-smi --query-gpu=index,name,memory.total --format=csv,noheader
echo ""

# Start LeRobot pi0 server
...
PYTHONPATH=$AGENTROBOT_ROOT/agentic/policy_websocket/src:$AGENTROBOT_ROOT/lerobot \
  ...
  --checkpoint lerobot/pi0_libero_finetuned --port $PORT &
PID=$!
