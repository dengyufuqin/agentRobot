...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-smolvla-libero_goal-%j.log
#SBATCH --nodelist=cn25




echo "=== Benchmark: smolvla on libero_goal ==="
