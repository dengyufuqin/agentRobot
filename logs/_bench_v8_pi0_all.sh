...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/eval-pi0-all-%j.log

# ============================================================
#  pi0 × LIBERO (4 suites) + ManiSkill (7 tasks)
# ============================================================
...
echo "============================================"
echo "  pi0 × LIBERO + ManiSkill (v8)"
echo "  $(date) | Node: $(hostname)"
echo "============================================"
nvidia-smi --query-gpu=index,name,memory.total --format=csv,noheader
echo ""

# Start pi0 server (uses lerobot policy_server.py)
...
for SUITE in libero_spatial libero_object libero_goal libero_10; do
  ...
  PYTHONPATH=$AGENTROBOT_ROOT/agentic/policy_websocket/src:$AGENTROBOT_ROOT/LIBERO \
    ...
    --policy_server_addr localhost:$PORT --policy pi0 --benchmark_name "$SUITE" \
