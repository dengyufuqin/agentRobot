...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-pi0-robotwin:beat_block_hammer-%j.log

#SBATCH --exclude=cn16,cn17,cn19



echo "=== Benchmark: pi0 on robotwin:beat_block_hammer ==="
