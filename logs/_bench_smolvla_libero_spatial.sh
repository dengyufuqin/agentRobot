...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-smolvla-libero_spatial-%j.log
#SBATCH --nodelist=cn24




echo "=== Benchmark: smolvla on libero_spatial ==="
