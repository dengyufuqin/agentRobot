...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-rdt-robotwin:place_empty_cup-%j.log

#SBATCH --exclude=cn16,cn17,cn19



echo "=== Benchmark: rdt on robotwin:place_empty_cup ==="
echo "Eval client: robotwin, Task: place_empty_cup"
echo "Node: $(hostname), GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader | head -1)"

# Step 1: Start server (CUDA_VISIBLE_DEVICES as prefix, not global)
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/mnt/vast/home/yd66byne/code/agentRobot/agentic/policy_websocket/src:/mnt/vast/home/yd66byne/code/agentRobot/RDT /mnt/vast/home/yd66byne/code/agentRobot/RDT/.venv/bin/python3 /mnt/vast/home/yd66byne/code/agentRobot/RDT/policy_server.py --checkpoint /mnt/vast/workspaces/JAIF/dy/datasets/agent_robot/checkpoints/robotwin_ckpts/robotwin2_place_empty_cup_RDT_step12k --port 27672 --robotwin &
SERVER_PID=$!

# Step 2: Wait for server
for i in $(seq 1 60); do
  curl -s http://localhost:27672/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
