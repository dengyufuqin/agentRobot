...
#  Fixed: num2words installed, correct LIBERO args
# ============================================================
...
echo "============================================"
echo "  SmolVLA × LIBERO + ManiSkill (v9)"
echo "  $(date) | Node: $(hostname)"
echo "============================================"
nvidia-smi --query-gpu=index,name,memory.total --format=csv,noheader
echo ""

# Start SmolVLA server
...
for SUITE in libero_spatial libero_object libero_goal libero_10; do
  ...
  PYTHONPATH=$AGENTROBOT_ROOT/agentic/policy_websocket/src:$AGENTROBOT_ROOT/LIBERO \
    ...
    --policy_server_addr localhost:$PORT --policy smolvla --task_suite_name "$SUITE" \
