...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-openpi-maniskill:PullCube-v1-%j.log

#SBATCH --exclude=cn16,cn17,cn19

export CPATH=/mnt/vast/home/yd66byne/.local/share/uv/python/cpython-3.11.15-linux-x86_64-gnu/include/python3.11:$CPATH
export C_INCLUDE_PATH=/mnt/vast/home/yd66byne/.local/share/uv/python/cpython-3.11.15-linux-x86_64-gnu/include/python3.11:$C_INCLUDE_PATH

echo "=== Benchmark: openpi on maniskill:PullCube-v1 ==="
echo "Eval client: maniskill, Task: PullCube-v1"
echo "Node: $(hostname), GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader | head -1)"

# Step 1: Start server (CUDA_VISIBLE_DEVICES as prefix, not global)
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/mnt/vast/home/yd66byne/code/agentRobot/agentic/policy_websocket/src:/mnt/vast/home/yd66byne/code/agentRobot/openpi/src /mnt/vast/home/yd66byne/code/agentRobot/openpi/.venv/bin/python3 /mnt/vast/home/yd66byne/code/agentRobot/openpi/scripts/policy_server.py --config pi05_libero --checkpoint /mnt/vast/workspaces/JAIF/dy/datasets/agent_robot/checkpoints/pi05-maniskill --port 20343 &
SERVER_PID=$!

# Step 2: Wait for server
for i in $(seq 1 60); do
  curl -s http://localhost:20343/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
