...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-openvla-maniskill:PickSingleYCB-v1-%j.log

#SBATCH --exclude=cn16,cn17,cn19

export HF_HOME=/mnt/vast/home/yd66byne/.cache/huggingface

echo "=== Benchmark: openvla on maniskill:PickSingleYCB-v1 ==="
