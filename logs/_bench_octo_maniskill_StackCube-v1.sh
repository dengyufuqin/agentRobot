...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-octo-maniskill:StackCube-v1-%j.log
...
echo "=== Benchmark: octo on maniskill:StackCube-v1 ==="
echo "Eval client: maniskill, Task: StackCube-v1"
echo "Node: $(hostname), GPU: $(nvidia-smi --query-gpu=name --format=csv,noheader | head -1)"

# Step 1: Start server (CUDA_VISIBLE_DEVICES as prefix, not global)
CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/mnt/vast/home/yd66byne/code/agentRobot/agentic/policy_websocket/src:/mnt/vast/home/yd66byne/code/agentRobot/octo /mnt/vast/home/yd66byne/code/agentRobot/octo/.venv/bin/python3 /mnt/vast/home/yd66byne/code/agentRobot/octo/policy_server.py --port 23989 --checkpoint /mnt/vast/workspaces/JAIF/dy/datasets/agent_robot/checkpoints/octo-maniskill &
SERVER_PID=$!

# Step 2: Wait for server
for i in $(seq 1 60); do
  curl -s http://localhost:23989/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
