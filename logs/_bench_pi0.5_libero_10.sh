...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-pi0.5-libero_10-%j.log
#SBATCH --nodelist=cn24,cn26,cn27




echo "=== Benchmark: pi0.5 on libero_10 ==="
...
for i in $(seq 1 60); do
  curl -s http://localhost:27851/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
