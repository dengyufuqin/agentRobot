...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/eval-pi05-ms2-%j.log

# ============================================================
#  pi0.5 × ManiSkill (7 tasks) — v10: pd_ee_delta_pose
# ============================================================
...
echo "============================================"
echo "  pi0.5 × ManiSkill (v10 — pd_ee_delta_pose)"
echo "  $(date) | Node: $(hostname)"
echo "============================================"
nvidia-smi --query-gpu=index,name,memory.total --format=csv,noheader
echo ""

# Start pi0.5 server (via LeRobot)
