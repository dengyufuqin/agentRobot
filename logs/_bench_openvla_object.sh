#!/bin/bash
#SBATCH --job-name=bench-obj
#SBATCH --partition=all
#SBATCH --gres=gpu:1
#SBATCH --time=02:00:00
#SBATCH --exclude=cn23
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/bench-openvla-object-%j.log
...
for i in $(seq 1 60); do
  curl -s http://localhost:18810/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
