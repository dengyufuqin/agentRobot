...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/eval-octo-rc-%j.log

# ============================================================
#  Octo × RoboCasa (kitchen tasks)
# ============================================================
...
for TASK in PnPCounterToCab PnPCabToCounter PnPCounterToSink OpenSingleDoor CloseSingleDoor TurnOnSinkFaucet; do
  echo ""
  echo "=========================================="
  echo "  EVAL: Octo on RoboCasa/$TASK ($(date))"
  echo "=========================================="
  ...
  echo "  → Octo on RoboCasa/$TASK: exit $?"
done
