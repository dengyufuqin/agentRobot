...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/benchmark-pi0-libero_object-%j.log
#SBATCH --nodelist=cn24,cn26,cn27




echo "=== Benchmark: pi0 on libero_object ==="
...
for i in $(seq 1 60); do
  curl -s http://localhost:27423/healthz > /dev/null 2>&1 && { echo "Server ready after ${i}0s"; break; }
