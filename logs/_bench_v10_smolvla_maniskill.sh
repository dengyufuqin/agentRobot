...
#SBATCH --output=/mnt/vast/home/yd66byne/code/agentRobot/logs/eval-smol-ms2-%j.log

# ============================================================
#  SmolVLA × ManiSkill (7 tasks) — v10: pd_ee_delta_pose
# ============================================================
...
echo "============================================"
echo "  SmolVLA × ManiSkill (v10 — pd_ee_delta_pose)"
